          ...
          <div class="slimscroll-menu" id="remove-scroll">
              ...
              <div id="sidebar-menu">
                  ...
                  <ul class="metismenu" id="side-menu">
                      ...
                      <li>
                          <a href="javascript:void(0);" class="waves-effect"><i class="ti-user"></i><span> Employees
                      ...
                      <li class="">
                          <a href="/present-report"
                              class="waves-effect {{ request()->is('present-report') || request()->is('present-report/*') ? 'mm active' : '' }}">
                               <i class="dripicons-to-do"></i> <span> Attendance Report </span>
                          </a>
                      </li>
                      <li class="">
                          <a href="/absent-report"
                              class="waves-effect {{ request()->is('absent-report') || request()->is('absent-report/*') ? 'mm active' : '' }}">
                              <i class="dripicons-to-do"></i> <span> Absent Report </span>
                          </a>
                      </li>
                      ...
                      <li class="">
                          <a href="/attendance-log"
                              class="waves-effect {{ request()->is('attendance-log') || request()->is('attendance-log/*') ? 'mm active' : '' }}">
                              <i class="ti-calendar"></i> <span> Attendance Device Data </span>
                          </a>
                      </li>
                      <li class="">
                          <a href="/latetime"
