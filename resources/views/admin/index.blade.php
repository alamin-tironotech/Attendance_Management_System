                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h6  class="font-16 text-uppercase mt-0 text-white-50" >Todays <br> Present</h6>
                                            <h4 class="font-500">{{$data[1]}}<i class="text-danger ml-2"></i></h4>
                                        ...
                                        <div class="pt-2">
                                            <div class="float-right">
                                                <a href="{{ route('present-report') }}" class="text-white-50"><i class="mdi mdi-arrow-right h5"></i></a>
                                            </div>
                                ...
                                <div class="card mini-stat bg-primary text-white">
                                    <div class="card-body">
                                        <div class="mb-4">
                                            ...
                                            <h5 class="font-16 text-uppercase mt-0 text-white-50">Todays <br> Absent</h5>
                                        ...
                                        <div class="pt-2">
                                            <div class="float-right">
                                                <a href="{{ route('absent-report') }}" class="text-white-50"><i class="mdi mdi-arrow-right h5"></i></a>
                                            </div>
